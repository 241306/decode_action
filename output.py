...
def get_info ():#line:135
    print ("="*50 +f'\n✅github：https://github.com/kxs2018/xiaoym\n✅极狐仓库:https://jihulab.com/xizhiai/xiaoym\n✅By:惜之酱\t\ttg群：http://t.me/xizhiaigroup\n'+'-'*50 )#line:137
    print (f"✅{_O0OOO00OOO000OOO0.get('msg')['甬派']}")#line:138
    O0OOOOOOO0OOO0O00 ='v1.0'#line:139
    OO0OO0OOOOOOOOOOO =_O0OOO00OOO000OOO0 ['version']['甬派']#line:140
    print ('-'*50 +f'\n当前版本{O0OOOOOOO0OOO0O00}，仓库版本{OO0OO0OOOOOOOOOOO}\n✅{_O0OOO00OOO000OOO0["update_log"]["甬派"]}')#line:141
    if O0OOOOOOO0OOO0O00 <OO0OO0OOOOOOOOOOO :#line:142
        print ('⛔️请到仓库下载最新版本k_yp.py')#line:143
    print ("="*50 )#line:144
def main ():#line:147
    get_info ()#line:148
    OOOOOOO00O00OO00O =os .getenv ('ypck')#line:149
    if not OOOOOOO00O00OO00O :#line:150
        print ('没有获取到甬派ck')#line:151
        exit ()#line:152
